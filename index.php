...
<main class="container">
    ...
    <section class="lots">
        ...
        $lots = [
            ...
            [
                "brand" => "DC Ply Mens 2016/2017 Snowboard",
                "category" => "Доски и лыжи",
                "price" => 159999,
                "url" => "img/lot-2.jpg"
            ],
            [
                "brand" => "Крепления Union Contact Pro 2015 года размер L/XL",
                "category" => "Крепления",
                "price" => 8000,
                "url" => "img/lot-3.jpg"
            ],
            [
                "brand" => "Ботинки для сноуборда DC Mutiny Charocal",
                "category" => "Ботинки",
                "price" => 10999,
                "url" => "img/lot-4.jpg"
            ],
            [
                "brand" => "Куртка для сноуборда DC Mutiny Charocal",
                "category" => "Одежда",
                "price" => 7500,
                "url" => "img/lot-5.jpg"
            ],
            [
                "brand" => "Маска Oakley Canopy",
                "category" => "Разное",
                "price" => 5400,
                "url" => "img/lot-6.jpg"
            ]
            ...
            <?php foreach ($lots as $key => $item): ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?=$item['url']; ?>" width="350" height="260" alt="<?=$item['brand']; ?>">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"></span>
                        <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?= $item['brand']; ?></a></h3>

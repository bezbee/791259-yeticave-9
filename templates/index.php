        ...
        <?php foreach ($lots as $key => $item): ?>
            <li class="lots__item lot">
                <div class="lot__image">
                    <img src="<?=$item['url']; ?>" width="350" height="260" alt="<?=htmlspecialchars($item['brand']); ?>">
                </div>
                <div class="lot__info">
                    <span class="lot__category"></span>
                    <h3 class="lot__title"><a class="text-link" href="pages/lot.html"><?=htmlspecialchars($item['brand']); ?></a></h3>
